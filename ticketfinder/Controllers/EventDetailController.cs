...
//                Id = ed.Id,
//                Name = ed.Name,
//                StageNames = ed.Stages.Select(s => s.Name).ToList(),
...
//                EventImages = new List<string>() { ed.EventImages },
...
//        {
//            Event ed = (Event)context.EventDetails.Include(ed => ed.Stages).FirstOrDefault(ed => ed.Id == id);
...
//            ed.EventImages = model.EventImages.ToString();
